...
| 预热池 | 已完成 | `mimobox-os` 与 `mimobox-vm` 均提供预热池，OS 级 P99 0.38us，microVM 热路径 P50 797us |
...
| microVM (KVM) | 冷启动 P50 | <200ms | `323ms` | 🔄 优化中 |
| microVM (KVM) | 快照恢复 P50 | <50ms | `71ms` | 🔄 优化中 |
| microVM (KVM) | 命令执行 P50 | — | `756us` | ✅ |
| microVM (KVM) | 预热池热路径 P50 | <1ms | `797us` | ✅ |
